...
class CatalogActivity : AppCompatActivity() {
    ...
    fun cargarSeries(){
        ...
        series.add(Pelicula("Mi adorable demonio", R.drawable.adorable_demonio, R.drawable.adorable_demonios, "Se centra en la vida de Jung Koo Won, un temerario demonio que pierde sus poderes tras conocer a Do Do-Hee, una exitosa empresaria con la que deberá de colaborar para recuperarlos."))
        series.add(Pelicula("El Monstruo de la Vieja Seúl", R.drawable.el_monstruo, R.drawable.elmonstruo_vieja, "Gyeongseong, 1945. En la oscura era colonial de Seúl, un empresario y una investigadora luchan por sobrevivir y se enfrentan a un monstruo nacido de la avaricia humana."))
