...
class CatalogActivity : AppCompatActivity() {
    ...
    fun cargarSeries(){
        ...
        series.add(Pelicula("Leveling", R.drawable.solo_leveling, R.drawable.solo_levelings, "En un mundo en el que ciertos humanos llamados “cazadores” poseen habilidades mágicas, estos deben luchar contra monstruos para proteger a la raza humana de una aniquilación segura. Un cazador muy débil llamado Sung Jinwoo se encuentra en una lucha en la que solo puede tratar de sobrevivir.", arrayListOf<Cliente>()))
        series.add(Pelicula("Mi adorable demonio", R.drawable.adorable_demonio, R.drawable.adorable_demonios, "Se centra en la vida de Jung Koo Won, un temerario demonio que pierde sus poderes tras conocer a Do Do-Hee, una exitosa empresaria con la que deberá de colaborar para recuperarlos.", arrayListOf<Cliente>()))
        series.add(Pelicula("El Monstruo de la Vieja Seúl", R.drawable.el_monstruo, R.drawable.elmonstruo_vieja, "Gyeongseong, 1945. En la oscura era colonial de Seúl, un empresario y una investigadora luchan por sobrevivir y se enfrentan a un monstruo nacido de la avaricia humana.", arrayListOf<Cliente>()))
    ...
    class PeliculaAdapter: BaseAdapter{
        ...
        override fun getView(
            ...
            image.setOnClickListener {
                var intento = Intent(context, MovieDetailActivity::class.java)
                ...
                if (CatalogActivity.peliculas.contains(pelicula)) {
                    intento.putExtra("tipo", "peli")
                } else {
                    intento.putExtra("tipo", "serie")
                }
